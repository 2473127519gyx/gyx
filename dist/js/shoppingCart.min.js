let trun = { convertStrToObj(t) { return t ? JSON.parse(t) : {} } }; class Cart {
    constructor() { this.cart = document.querySelector(".cartbox"), this.selectAll = document.querySelector("#selectAll"), this.flag = !0, this.init() } init() {
        let o = this, t = window.localStorage; var n, e = t.getItem("products") ? t.getItem("products") : "", l = trun.convertStrToObj(e); for (n in l) {
            var r = l[n]; let t = document.createElement("ul"); t.className = "buy", t.setAttribute("data-good-id", n), t.innerHTML = `<li>
